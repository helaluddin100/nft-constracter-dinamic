...
class DemoForm extends Component {
    state={
      ...
      Subscriber = async (e) => {
        e.preventDefault();
        const res = await axios.post("http://localhost:8000/api/subscriber", this.state);
          ...
          <div className="newsletter-content">
            ...
            <div className="subscribe-inputs">
              ...
              <div className="input-withbtn">
                <input type="email" required name='email' onChange={this.handelInput} value={this.state.email} placeholder="Enter Email Address" />
