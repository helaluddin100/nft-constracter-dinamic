...
class DemoForm extends Component {
    state={
      ...
      getDemo = async (e) => {
        e.preventDefault();
        const res = await axios.post("http://localhost:8000/api/demo", this.state);
                ...
                <form onSubmit={this.getDemo}>
                  <div className="form-group-2">
                    ...
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <input
                          type="text"
                          name="phone"onChange={this.handelInput} value={this.state.phone}
                  ...
                  <div className="form-group-2">
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <input
                          type="email"
                          name="email"onChange={this.handelInput} value={this.state.email}
                          className="form-control"
                    ...
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <input
                          type="text"
                          onChange={this.handelInput} value={this.state.whatsapp}
                          name="whatsapp"
                  ...
                  <div className="form-group">
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <textarea
                          name="message"onChange={this.handelInput} value={this.state.message}
                          className="form-control"
                          cols="30"
                          rows="10"
                        ></textarea>
