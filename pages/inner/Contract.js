...
export default class Contract extends Component {
    ...
    state={
      ...
      Contract = async (e) => {
        e.preventDefault();
        const res = await axios.post("http://localhost:8000/api/contract", this.state);
                ...
                <form onSubmit={this.Contract}>
                  ...
                  <div className="form-group-2">
                    ...
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <input
                          type="text"
                          onChange={this.handelInput} value={this.state.subject}
                          required
                          name="subject"
                          placeholder="Subject"
                          className="form-control with-select"
                  ...
                  <div className="form-group">
                    <div className="input-group">
                      ...
                      <div className="input-box">
                        <textarea
                          onChange={this.handelInput} value={this.state.message}
                          required
                          name="message"
                          className="form-control"
                          cols="30"
