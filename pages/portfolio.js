          ...
          <div className="container">
            ...
            <div className="portfolio-item">
              ...
              {portfolio.map((portfolio, index) => (
                <div  className={index % 2 ? 'prof-item cg-direction cpy-5' : 'prof-item cpy-5'}>
                  <div
                    className="prof-des"
                  ...
                  >
                    ...
                    <a href={portfolio.link} target={"_blank"} className="view-shot">
                      Visit Live Site
                  ...
                  >
                    <img
                      ...
                      alt={portfolio.name}
                    />
                    <div className={ index % 2 ? 'prof-right' : 'prof-left'}></div>
                  </div>
                </div>
              ))}
